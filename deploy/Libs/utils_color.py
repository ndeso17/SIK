...
def get_dominant_color(image_bgr):
    ...
    color_ranges = {'Merah': [([0, 50, 50], [10, 255, 255]), ([170, 50, 50], [180, 255, 255])], 'Hitam': [([0, 0, 0], [180, 255, 50])], 'Putih': [([0, 0, 200], [180, 30, 255])], 'Abu-abu': [([0, 0, 50], [180, 50, 200])], 'Biru': [([100, 50, 50], [130, 255, 255])], 'Hijau': [([35, 50, 50], [85, 255, 255])], 'Kuning': [([20, 50, 50], [35, 255, 255])], 'Oranye': [([10, 50, 50], [20, 255, 255])], 'Ungu': [([130, 50, 50], [170, 255, 255])]}
    (h, w, _) = hsv_image.shape
    (center_h, center_w) = (h // 2, w // 2)
    (crop_h, crop_w) = (max(1, h // 4), max(1, w // 4))
